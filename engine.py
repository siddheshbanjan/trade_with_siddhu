...
def run_scan():
    ...
    # Apply sector diversity cap — max 2 per sector in top 10
    SECTORS = {
        "NIFTY":"Index","BANKNIFTY":"Index",
        "HDFCBANK":"Banks","ICICIBANK":"Banks","AXISBANK":"Banks","KOTAKBANK":"Banks","SBIN":"Banks",
        "RELIANCE":"Energy","ADANIENT":"Energy",
        "TCS":"IT","INFY":"IT","WIPRO":"IT",
        "BAJFINANCE":"NBFC","MARUTI":"Auto","SUNPHARMA":"Pharma","LT":"Infra",
    }
    top_raw = [s for s in signals if s["action"] in ("BUY","SELL")]
    top = []; sector_count = {}
    for s in top_raw:
        sec = SECTORS.get(s["sym"], "Other")
