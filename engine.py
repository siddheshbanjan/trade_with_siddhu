...
=============
Data sources:
  1. NSE scraper  — live quotes, VIX
  2. yfinance     — historical OHLCV (60d)
  3. Stooq        — fallback OHLCV
...
def nse_get(path, params=None, retries=2):
    ...
    for attempt in range(retries):
        try:
            r = s.get(url, params=params, timeout=8)  # short timeout — fail fast on Railway
...
WATCHLIST = {
    # Index
    "NIFTY":      {"yf":"^NSEI",           "lot":50,   "name":"Nifty 50",       "index":True,  "nse":"NIFTY 50",         "sector":"Index"},
    "BANKNIFTY":  {"yf":"^NSEBANK",        "lot":15,   "name":"Bank Nifty",     "index":True,  "nse":"NIFTY BANK",       "sector":"Index"},
    # Banks
    "HDFCBANK":   {"yf":"HDFCBANK.NS",     "lot":550,  "name":"HDFC Bank",      "index":False, "nse":"HDFCBANK",         "sector":"Banks"},
    "ICICIBANK":  {"yf":"ICICIBANK.NS",    "lot":700,  "name":"ICICI Bank",     "index":False, "nse":"ICICIBANK",        "sector":"Banks"},
    "KOTAKBANK":  {"yf":"KOTAKBANK.NS",    "lot":400,  "name":"Kotak Bank",     "index":False, "nse":"KOTAKBANK",        "sector":"Banks"},
    "AXISBANK":   {"yf":"AXISBANK.NS",     "lot":625,  "name":"Axis Bank",      "index":False, "nse":"AXISBANK",         "sector":"Banks"},
    "SBIN":       {"yf":"SBIN.NS",         "lot":1500, "name":"SBI",            "index":False, "nse":"SBIN",             "sector":"Banks"},
    "INDUSINDBK": {"yf":"INDUSINDBK.NS",   "lot":700,  "name":"IndusInd Bank",  "index":False, "nse":"INDUSINDBK",       "sector":"Banks"},
    "BANKBARODA": {"yf":"BANKBARODA.NS",   "lot":3800, "name":"Bank of Baroda", "index":False, "nse":"BANKBARODA",       "sector":"Banks"},
    # IT
    "TCS":        {"yf":"TCS.NS",          "lot":150,  "name":"TCS",            "index":False, "nse":"TCS",              "sector":"IT"},
    "INFY":       {"yf":"INFY.NS",         "lot":300,  "name":"Infosys",        "index":False, "nse":"INFY",             "sector":"IT"},
    "WIPRO":      {"yf":"WIPRO.NS",        "lot":1500, "name":"Wipro",          "index":False, "nse":"WIPRO",            "sector":"IT"},
    "HCLTECH":    {"yf":"HCLTECH.NS",      "lot":350,  "name":"HCL Tech",       "index":False, "nse":"HCLTECH",          "sector":"IT"},
    "TECHM":      {"yf":"TECHM.NS",        "lot":600,  "name":"Tech Mahindra",  "index":False, "nse":"TECHM",            "sector":"IT"},
    "LTIM":       {"yf":"LTIM.NS",         "lot":150,  "name":"LTIMindtree",    "index":False, "nse":"LTIM",             "sector":"IT"},
    # Energy
    "RELIANCE":   {"yf":"RELIANCE.NS",     "lot":250,  "name":"Reliance",       "index":False, "nse":"RELIANCE",         "sector":"Energy"},
    "ONGC":       {"yf":"ONGC.NS",         "lot":1925, "name":"ONGC",           "index":False, "nse":"ONGC",             "sector":"Energy"},
    "IOC":        {"yf":"IOC.NS",          "lot":2000, "name":"Indian Oil",     "index":False, "nse":"IOC",              "sector":"Energy"},
    "BPCL":       {"yf":"BPCL.NS",         "lot":1800, "name":"BPCL",           "index":False, "nse":"BPCL",             "sector":"Energy"},
    "ADANIENT":   {"yf":"ADANIENT.NS",     "lot":625,  "name":"Adani Ent.",     "index":False, "nse":"ADANIENT",         "sector":"Energy"},
    # Auto
    "MARUTI":     {"yf":"MARUTI.NS",       "lot":100,  "name":"Maruti",         "index":False, "nse":"MARUTI",           "sector":"Auto"},
    "TATAMOTORS": {"yf":"TATAMOTORS.NS",   "lot":1425, "name":"Tata Motors",    "index":False, "nse":"TATAMOTORS",       "sector":"Auto"},
    "M&M":        {"yf":"M&M.NS",          "lot":350,  "name":"M&M",            "index":False, "nse":"M&M",              "sector":"Auto"},
    "BAJAJ-AUTO": {"yf":"BAJAJ-AUTO.NS",   "lot":125,  "name":"Bajaj Auto",     "index":False, "nse":"BAJAJ-AUTO",       "sector":"Auto"},
    "EICHERMOT":  {"yf":"EICHERMOT.NS",    "lot":175,  "name":"Eicher Motors",  "index":False, "nse":"EICHERMOT",        "sector":"Auto"},
    # NBFC
    "BAJFINANCE": {"yf":"BAJFINANCE.NS",   "lot":125,  "name":"Bajaj Finance",  "index":False, "nse":"BAJFINANCE",       "sector":"NBFC"},
    "BAJAJFINSV": {"yf":"BAJAJFINSV.NS",   "lot":125,  "name":"Bajaj Finserv",  "index":False, "nse":"BAJAJFINSV",       "sector":"NBFC"},
    "SBILIFE":    {"yf":"SBILIFE.NS",      "lot":375,  "name":"SBI Life",       "index":False, "nse":"SBILIFE",          "sector":"NBFC"},
    "HDFCLIFE":   {"yf":"HDFCLIFE.NS",     "lot":1100, "name":"HDFC Life",      "index":False, "nse":"HDFCLIFE",         "sector":"NBFC"},
    # Pharma
    "SUNPHARMA":  {"yf":"SUNPHARMA.NS",    "lot":350,  "name":"Sun Pharma",     "index":False, "nse":"SUNPHARMA",        "sector":"Pharma"},
    "DRREDDY":    {"yf":"DRREDDY.NS",      "lot":125,  "name":"Dr Reddy",       "index":False, "nse":"DRREDDY",          "sector":"Pharma"},
    "CIPLA":      {"yf":"CIPLA.NS",        "lot":650,  "name":"Cipla",          "index":False, "nse":"CIPLA",            "sector":"Pharma"},
    "DIVISLAB":   {"yf":"DIVISLAB.NS",     "lot":200,  "name":"Divi's Lab",     "index":False, "nse":"DIVISLAB",         "sector":"Pharma"},
    # Infra
    "LT":         {"yf":"LT.NS",           "lot":175,  "name":"L&T",            "index":False, "nse":"LT",               "sector":"Infra"},
    "ADANIPORTS": {"yf":"ADANIPORTS.NS",   "lot":1250, "name":"Adani Ports",    "index":False, "nse":"ADANIPORTS",       "sector":"Infra"},
    "POWERGRID":  {"yf":"POWERGRID.NS",    "lot":2700, "name":"Power Grid",     "index":False, "nse":"POWERGRID",        "sector":"Infra"},
    "NTPC":       {"yf":"NTPC.NS",         "lot":2700, "name":"NTPC",           "index":False, "nse":"NTPC",             "sector":"Infra"},
    # Metals
    "TATASTEEL":  {"yf":"TATASTEEL.NS",    "lot":5500, "name":"Tata Steel",     "index":False, "nse":"TATASTEEL",        "sector":"Metals"},
    "HINDALCO":   {"yf":"HINDALCO.NS",     "lot":2150, "name":"Hindalco",       "index":False, "nse":"HINDALCO",         "sector":"Metals"},
    "JSWSTEEL":   {"yf":"JSWSTEEL.NS",     "lot":1350, "name":"JSW Steel",      "index":False, "nse":"JSWSTEEL",         "sector":"Metals"},
    "COALINDIA":  {"yf":"COALINDIA.NS",    "lot":4200, "name":"Coal India",     "index":False, "nse":"COALINDIA",        "sector":"Metals"},
    # FMCG
    "HINDUNILVR": {"yf":"HINDUNILVR.NS",   "lot":500,  "name":"HUL",            "index":False, "nse":"HINDUNILVR",       "sector":"FMCG"},
    "ITC":        {"yf":"ITC.NS",          "lot":3200, "name":"ITC",            "index":False, "nse":"ITC",              "sector":"FMCG"},
    "NESTLEIND":  {"yf":"NESTLEIND.NS",    "lot":40,   "name":"Nestle India",   "index":False, "nse":"NESTLEIND",        "sector":"FMCG"},
    # Telecom
    "BHARTIARTL": {"yf":"BHARTIARTL.NS",   "lot":475,  "name":"Airtel",         "index":False, "nse":"BHARTIARTL",       "sector":"Telecom"},
    # Cement
    "ULTRACEMCO": {"yf":"ULTRACEMCO.NS",   "lot":100,  "name":"UltraTech",      "index":False, "nse":"ULTRACEMCO",       "sector":"Cement"},
    "SHREECEM":   {"yf":"SHREECEM.NS",     "lot":25,   "name":"Shree Cement",   "index":False, "nse":"SHREECEM",         "sector":"Cement"},
    # Consumer
    "ASIANPAINT": {"yf":"ASIANPAINT.NS",   "lot":300,  "name":"Asian Paints",   "index":False, "nse":"ASIANPAINT",       "sector":"Consumer"},
    "TITAN":      {"yf":"TITAN.NS",        "lot":375,  "name":"Titan",          "index":False, "nse":"TITAN",            "sector":"Consumer"},
}
...
state = {
    ...
    # Signal age tracking — when each stock first appeared in top list
    "signal_first_seen": {},  # {sym: "HH:MM"} — time first entered top list
    "signal_scan_count": {},  # {sym: int} — how many consecutive scans in top list
    "signal_last_seen":  {},  # {sym: "HH:MM"} — last scan time it appeared
}
...
def fetch_india_vix():
    """NSE API → yfinance fallback chain."""
    # Method 1: NSE scraper
    try:
...
def get_weights(vix):
    ...
    if vix > 22:
        return {"tech": 50, "mom": 15, "oi": 35, "regime": f"high fear (VIX {vix:.1f} > 22)"}
    elif vix > 18:
        return {"tech": 45, "mom": 25, "oi": 30, "regime": f"elevated (VIX {vix:.1f} 18-22)"}
    elif vix < 12:
        return {"tech": 30, "mom": 45, "oi": 25, "regime": f"low/sideways (VIX {vix:.1f} < 12)"}
    else:
        return {"tech": 40, "mom": 35, "oi": 25, "regime": f"normal (VIX {vix:.1f})"}

def live_quote(sym):
    """NSE live quote with yfinance fallback."""
    try:
        m = WATCHLIST[sym]
        if m["index"]:
            d = nse_get("/api/allIndices")
...
def fetch_oi(sym, hist_data=None, spot=None):
    """NSE → yfinance/proxy fallback chain."""
    # Method 1: NSE scraper
    d = fetch_oi_nse(sym)
    if d: return d
...
# ══════════════════════════════════════════════════════════════════════════════
# STRATEGY ONE — Anomaly-Based Scoring (rotates daily)
# ══════════════════════════════════════════════════════════════════════════════
# Core idea: score HOW UNUSUAL today is vs last 20 days for each stock.
# HDFCBANK trending for 3 months = nothing unusual = score ~50
# WIPRO suddenly up 3% on 4x volume = very unusual = score 80+
# This naturally rotates the top list every day.

def score_stock_ONE(sym, hist, lq, oid, weights=None, intraday=None, nifty_change=0):
    try:
        ...
        vs  = float(np.std(v[-20:]))  if len(v)>=20 else va*0.3
        vr  = round(vol_today/va, 2) if va>0 else 1.0

        # ── Market closed? Use multi-day momentum ────────────────────────────
        market_open = state.get("market_status") == "OPEN"
        if not market_open and len(c) >= 6:
            change_3d  = round((c[-1] - c[-4]) / c[-4] * 100, 2) if len(c) >= 4 else change_pct
            change_pct = change_3d if abs(change_3d) > abs(change_pct) else change_pct
            vol_today  = float(np.mean(v[-3:])) if len(v) >= 3 else vol_today

        # ── Relative strength vs NIFTY ────────────────────────────────────────
        # Key insight: a stock up 1% when NIFTY is up 2% is UNDERPERFORMING
        # A stock up 2% when NIFTY is up 0.5% is OUTPERFORMING — much better signal
        rel_strength = round(change_pct - (nifty_change or 0), 2)

        # ── Intraday data (30-min candles from Upstox) ────────────────────────
        intra_vwap   = None
        intra_vol_surge = 1.0
        intra_rsi    = None
        if intraday and len(intraday.get("closes", [])) >= 3:
            ic = intraday["closes"]; ih = intraday["highs"]
            il = intraday["lows"];   iv = intraday["volumes"]
            # Real intraday VWAP
            intra_vwap = vwap_val(ih, il, ic, iv)
            # Volume surge in last candle vs intraday average
            intra_avg_vol = float(np.mean(iv[:-1])) if len(iv) > 1 else iv[-1]
            intra_vol_surge = round(iv[-1] / intra_avg_vol, 2) if intra_avg_vol > 0 else 1.0
            # Intraday RSI
            if len(ic) >= 5:
                intra_rsi = rsi(ic)

        # Use intraday VWAP if available (more accurate than 20-day daily VWAP)
        if intra_vwap and intra_vwap > 0:
            vw = intra_vwap

        reasons = []

        # ── Daily return z-score (how unusual is today vs last 20 days) ────────
        returns = [((cl[i]-cl[i-1])/cl[i-1]*100) for i in range(1, len(cl))]
        if len(returns) >= 10:
            avg_ret  = float(np.mean(returns[-20:]))
            std_ret  = float(np.std(returns[-20:])) or 0.5
            return_z = (change_pct - avg_ret) / std_ret
        else:
            return_z = change_pct / 1.5

        # Volume z-score
        vol_z = (vol_today - va) / vs if vs > 0 else 0

        # ── SCORE COMPONENT 1: Relative Strength vs NIFTY (PRIMARY signal) ───
        # This is the key differentiator — changes every day
        # +ve rel_strength = outperforming market today = bullish
        # -ve rel_strength = underperforming market today = bearish/short
        tech = int(W_TECH * 0.4)  # start at 40% of max
        if rel_strength > 2.0:    tech += int(W_TECH*0.6);  reasons.append(f"Strong outperformer vs NIFTY: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}% (+{rel_strength:.1f}% RS) 🟢🟢")
        elif rel_strength > 1.0:  tech += int(W_TECH*0.4);  reasons.append(f"Outperforming NIFTY: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}% (+{rel_strength:.1f}% RS) 🟢")
        elif rel_strength > 0.3:  tech += int(W_TECH*0.2);  reasons.append(f"Slightly outperforming: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}% 🟡")
        elif rel_strength > -0.3:                             reasons.append(f"In line with market: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}%")
        elif rel_strength < -2.0: tech -= int(W_TECH*0.5);  reasons.append(f"Strong underperformer: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}% ({rel_strength:.1f}% RS) 🔴")
        elif rel_strength < -1.0: tech -= int(W_TECH*0.3);  reasons.append(f"Underperforming NIFTY: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}% 🔴")
        elif rel_strength < -0.3: tech -= int(W_TECH*0.1);  reasons.append(f"Slight underperformer: {change_pct:+.1f}% vs NIFTY {nifty_change:+.1f}% 🟡")

        # Boost from raw anomaly (unusual vs OWN history)
        if return_z > 2:    tech += int(W_TECH*0.2); reasons.append(f"Also unusual vs own history: {return_z:.1f}σ 🟢")
        elif return_z < -2: tech -= int(W_TECH*0.15); reasons.append(f"Unusual down move vs history: {return_z:.1f}σ 🔴")

        # Intraday RSI boost (if available — more accurate than daily RSI)
        if intra_rsi is not None:
            if intra_rsi < 35:   tech += int(W_TECH*0.15); reasons.append(f"Intraday RSI {intra_rsi:.0f} — oversold (30-min) 🟢")
            elif intra_rsi > 70: tech -= int(W_TECH*0.1);  reasons.append(f"Intraday RSI {intra_rsi:.0f} — overbought (30-min) ⚠️")
        else:
            # Fallback to daily RSI
            if r_v < 35:    tech += int(W_TECH*0.1); reasons.append(f"RSI {r_v} — oversold 🟢")
            elif r_v > 68:  tech -= int(W_TECH*0.1); reasons.append(f"RSI {r_v} — overbought 🔴")

        tech = max(0, min(W_TECH, tech))

        # ── SCORE COMPONENT 2: Volume conviction ─────────────────────────────
        mom = int(W_MOM * 0.4)

        # Intraday volume surge (last candle vs intraday avg) — best signal
        if intra_vol_surge > 3.0:  mom += int(W_MOM*0.6); reasons.append(f"Intraday volume surge {intra_vol_surge:.1f}x — strong institutional activity 🟢🟢")
        elif intra_vol_surge > 2.0:mom += int(W_MOM*0.4); reasons.append(f"Intraday volume {intra_vol_surge:.1f}x above intraday avg 🟢")
        elif intra_vol_surge > 1.4:mom += int(W_MOM*0.2); reasons.append(f"Intraday volume elevated {intra_vol_surge:.1f}x 🟡")

        # Daily volume z-score
        if vol_z > 2:    mom += int(W_MOM*0.3); reasons.append(f"Daily volume spike: {vr:.1f}x avg ({vol_z:.1f}σ) 🟢")
        elif vol_z > 1:  mom += int(W_MOM*0.15);reasons.append(f"Above avg daily volume: {vr:.1f}x 🟡")
        elif vol_z < -1: mom -= int(W_MOM*0.2); reasons.append(f"Low volume: {vr:.1f}x avg — weak conviction ⚠️")
        else:                                    reasons.append(f"Normal volume: {vr:.1f}x avg")

        # Confluence: outperforming AND high volume = very strong signal
        if rel_strength > 1 and (vol_z > 1 or intra_vol_surge > 1.5):
            bonus = int(W_MOM*0.25)
            mom  += bonus
            reasons.append(f"Confluence: outperforming market + high volume (+{bonus} pts) 🟢🟢")
        mom = max(0, min(W_MOM, mom))

        # ── SCORE COMPONENT 3: Technical context (BUY vs SELL direction) ─────
        # Only used to determine direction and fine-tune, not to dominate score
        oi_s = int(W_OI * 0.5); pcr=1.0; max_pain=round(spot/50)*50; atm_iv=0
        if oid:
            pcr=oid["pcr"]; max_pain=oid["max_pain"]; atm_iv=oid.get("atm_iv",0)
            ob=oid["oi_buildup"]; oi_src=oid.get("src","proxy")
            if ob=="long":    oi_s+=int(W_OI*0.5);  reasons.append(f"Long OI buildup [{oi_src}] 🟢")
            elif ob=="short": oi_s-=int(W_OI*0.35); reasons.append(f"Short OI buildup [{oi_src}] 🔴")
            else:                                     reasons.append(f"Neutral OI — PCR {pcr} [{oi_src}]")
            if oi_src=="vol_proxy": reasons.append("⚪ OI via volume proxy")
        else:
            # Proxy from price+vol direction
            if change_pct > 1 and vr > 1.5:    oi_s += int(W_OI*0.3); reasons.append("OI proxy: up move + high vol → likely long 🟡")
            elif change_pct < -1 and vr > 1.5: oi_s -= int(W_OI*0.2); reasons.append("OI proxy: down move + high vol → likely short 🟡")
        oi_s = max(0, min(W_OI, oi_s))

        score = tech + mom + oi_s

        # ── Direction: technical structure determines CE vs PE ────────────────
        above_vwap = spot > vw
        above_e20  = spot > e20
        rsi_ok     = r_v < 68

        # Strong bullish anomaly
        if return_z > 0.8 and (above_vwap or above_e20) and rsi_ok:
            action = "BUY";  opt = "CE"
        # Moderate bullish + good technicals
        elif return_z > 0.3 and above_vwap and above_e20 and mb and rsi_ok:
            action = "BUY";  opt = "CE"
        # Strong bearish anomaly
        elif return_z < -0.8 and (not above_vwap or not above_e20):
            action = "SELL"; opt = "PE"
        # Moderate bearish
        elif return_z < -0.3 and not above_vwap and not above_e20 and not mb:
            action = "SELL"; opt = "PE"
        # Score-based fallback
        elif score >= 62:
            action = "BUY" if (above_vwap or change_pct > 0) else "SELL"
            opt    = "CE"  if action == "BUY" else "PE"
        elif score <= 35:
            action = "SELL"; opt = "PE"
        else:
            action = "HOLD"
            opt    = "CE" if change_pct >= 0 else "PE"

        # Add technical context to reasons
        reasons.append(f"Technical context: RSI {r_v} | {'Above' if above_vwap else 'Below'} VWAP ₹{vw:.0f} | {'Above' if above_e20 else 'Below'} EMA20 ₹{e20:.0f}")
        if mb: reasons.append("MACD bullish 🟢")
        else:  reasons.append("MACD bearish 🔴")
        if spot < bl: reasons.append("At Bollinger lower band — reversal zone 🟢")
        ...
        return {
            ...
            "rsi":r_v,"ema20":round(e20,2),"ema50":round(e50,2),"macd_bull":bool(mb),
            ...
            "return_z":round(return_z,2),"vol_z":round(vol_z,2),
            "rel_strength":round(rel_strength,2),"intra_rsi":round(intra_rsi,1) if intra_rsi else r_v,
            "intra_vol_surge":round(intra_vol_surge,2),"intra_vwap":round(intra_vwap,1) if intra_vwap else vw,
            "w_tech":W_TECH,"w_mom":W_MOM,"w_oi":W_OI,
            ...
            "sector":WATCHLIST.get(sym,{}).get("sector","Other"),
            "first_seen":None,"scan_count_in_top":0,
        }
    except Exception as e:
        print(f"  ONE error {sym}: {e}"); return None
...
def run_scan():
    ...
    with ThreadPoolExecutor(max_workers=5) as ex:
        ...
        try:
            for f in as_completed(futs, timeout=120):
                sym = futs[f]
                try:
                    _, d = f.result(timeout=25)
                    hist[sym] = d if d else None
                except Exception as e:
                    hist[sym] = None
        except TimeoutError:
    ...
    with ThreadPoolExecutor(max_workers=4) as ex:
        ...
        try:
            for f in as_completed(futs, timeout=60):
                sym = futs[f]
                try:
                    q = f.result(timeout=12)
                    if q and q["spot"] > 0: lqs[sym] = q; nse_ok += 1
                except: pass
        except TimeoutError:
            print("  ⚠ live quote timeout — using partial results")
    ...
    # 2.5 — Relative strength baseline (NIFTY today's change)
    intraday = {}  # placeholder for future intraday data source
    nifty_change = lqs.get("NIFTY", {}).get("change_pct", 0) or 0
    print(f"  [2.5] Relative strength baseline — NIFTY: {nifty_change:+.2f}%")

    # 3 — OI (NSE → yfinance fallback, sequential + delay)
    print("  [3/4] Option chain OI (proxy only — fast)...")
    oids = {}; oi_ok = 0
    # Use volume proxy directly — NSE OI is blocked on Railway
    # This is fast (no network calls) and still differentiates stocks
    for sym in WATCHLIST:
        spot = lqs.get(sym, {}).get("spot", 0) or (hist[sym]["closes"][-1] if hist.get(sym) else 0)
        if spot > 0 and hist.get(sym):
            d = fetch_oi_yfinance(sym, spot, hist.get(sym))
            if d: oids[sym] = d; oi_ok += 1
    state["fetched"] = 0
    print(f"         ✓ {oi_ok}/{len(WATCHLIST)} OI (vol proxy)")
    ...
    for sym in WATCHLIST:
        ...
        # Strategy ONE
        sig1 = score_stock_ONE(sym, hist[sym], lqs.get(sym), oids.get(sym),
                               weights=state["weights"],
                               intraday=intraday.get(sym),
    ...
    # ── Final sort — anomaly scoring already handles rotation naturally ─────────
    # Stocks with nothing unusual today will score ~50 and won't appear in top
    signals.sort(key=lambda x:(
        0 if x["action"]=="BUY" else 1 if x["action"]=="SELL" else 2,
        -x["score"]
    ))
    # Sector diversity cap — max 2 per sector, uses sector field from WATCHLIST
    top_raw = [s for s in signals if s["action"] in ("BUY","SELL")]
    top = []; sector_count = {}
    for s in top_raw:
        sec = WATCHLIST.get(s["sym"], {}).get("sector", "Other")
        if sector_count.get(sec, 0) < 2:
            top.append(s)
            sector_count[sec] = sector_count.get(sec, 0) + 1
        if len(top) >= 10: break

    # ── Signal age tracking — when did each stock first appear? ──────────────
    now_str = datetime.datetime.now().strftime("%I:%M %p")
    cur_syms = {s["sym"] for s in top}
    prev_syms = {s["sym"] for s in state.get("top_calls", [])}

    for s in top:
        sym = s["sym"]
        if sym not in state["signal_first_seen"]:
            # First time appearing — record now
            state["signal_first_seen"][sym] = now_str
            state["signal_scan_count"][sym]  = 1
        else:
            # Already seen — increment scan count
            state["signal_scan_count"][sym] = state["signal_scan_count"].get(sym, 0) + 1
        state["signal_last_seen"][sym] = now_str
        # Attach age info directly to signal
        s["first_seen"]  = state["signal_first_seen"][sym]
        s["scan_count_in_top"] = state["signal_scan_count"][sym]

    # Clear stocks that dropped out of top list
    dropped = prev_syms - cur_syms
    for sym in dropped:
        state["signal_first_seen"].pop(sym, None)
        state["signal_scan_count"].pop(sym, None)
        state["signal_last_seen"].pop(sym, None)
    ...
    print(f"\n✅ ONE: {b} BUY·{se} SELL  |  DEV: {dw}  |  TWO: {tw}  |  SWING: {sw}  |  errors: {len(state['errors'])}  |  time: {elapsed}s")
    print(f"{'='*60}\n")
...
.age-fresh{background:#00ffa318;color:#00ffa3;border:1px solid #00ffa340;font-size:10px;padding:3px 8px;border-radius:4px;font-weight:700}
.age-aging{background:#ffb83018;color:#ffb830;border:1px solid #ffb83040;font-size:10px;padding:3px 8px;border-radius:4px;font-weight:700}
.age-stale{background:#ff3d5a18;color:#ff3d5a;border:1px solid #ff3d5a40;font-size:10px;padding:3px 8px;border-radius:4px;font-weight:700}
...
function cardHtml(s){
  ...
  if(isSwing){
    ...
    <div class="card-head">
      <div>
        <div style="display:flex;align-items:center;gap:5px;margin-bottom:3px;flex-wrap:wrap">
          ...
          ${s.sector?`<span style="font-size:9px;color:#3d5068;padding:2px 5px;border:1px solid #1a2235;border-radius:3px">${s.sector}</span>`:``}
        ...
        ${s.first_seen ? `<div style="display:flex;align-items:center;gap:6px;margin-top:4px">
          <span class="${(s.scan_count_in_top||1)<=1?'age-fresh':(s.scan_count_in_top||1)<=3?'age-aging':'age-stale'}">
            ${(s.scan_count_in_top||1)<=1?'🆕 NEW':'⏱ Since '+s.first_seen}
          </span>
          ${(s.scan_count_in_top||1)>1?`<span style="font-size:10px;color:#3d5068">${s.scan_count_in_top} scans (${Math.round((s.scan_count_in_top||1)*15)} min)</span>`:''}
        </div>` : ''}
      </div>
    ...
    <div class="oi-row">
      ...
      <div class="oi-item"><span style="font-size:9px;color:#3d5068">${isDev?'Src':isTwo?'Mode':'RS'}</span><span class="mono" style="color:${!isDev&&!isTwo?(s.rel_strength>1?'#00ffa3':s.rel_strength<-1?'#ff3d5a':'#6b8299'):'#6b8299'}">${isDev?(s.oi_src||'?'):isTwo?(s.mode||'?'):(s.rel_strength!=null?(s.rel_strength>0?'+':'')+s.rel_strength+'%':s.vol_ratio+'x')}</span></div>
    </div>
    <div class="levels">
...
def run_scan_safe():
    ...
    try:
        ...
        # Guarantee lock is always released regardless of what happens
        if state.get("is_scanning"):
            print("  ⚠ Force-releasing scan lock in finally block")
            state["is_scanning"] = False
...
╚══════════════════════════════════════════════════════════╝
""")
    print(f"  NSE data      : Live quotes + OI chain (yfinance fallback)")
